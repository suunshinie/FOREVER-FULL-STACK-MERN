    ...
    <div className='bg-gray-400 min-h-screen flex items-center justify-center w-full'>
      <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <button className='mt-2 w-full py-2 px-4 rounded-md text-white bg-violet-400 hover:bg-violet-700 transition-colors duration-300' type="submit"> Login </button>
        </form>
      </div>
    </div>
  )
